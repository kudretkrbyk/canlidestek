...
const LiveChat = ({ _customerInfo, socket }) => {
  ...
  //const { supportAgentMessages } = customerMessageStore();

  const [message, setMessage] = useState("");
  const [_supportAgentMessages, _setSupportAgentMessages] = useState("");
  ...
  //   _setSupportAgentMessages((prevMessages) => [
  //     ...prevMessages,
    ...
    <div>
      ...
      {liveCustomerMessages.map((_customerMessage, index) => (
        <div>
          ...
          {_supportAgentMessages &&
            _supportAgentMessages.map((_supportAgentMessages, index) => (
              <div
